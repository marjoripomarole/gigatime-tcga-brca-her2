...
| HER2-low | 11 | TCGA-A2-A0SV | IHC score 2+ and ISH negative | 2+ | Negative | Positive | Positive | 110.2 | yes |
| HER2-low | 12 | TCGA-A2-A0CT | IHC score 2+ and ISH negative | 2+ | Negative | Positive | Negative | 257.9 | yes |
| HER2-low | 13 | TCGA-A1-A0SJ | IHC score 2+ and ISH negative | 2+ | Negative | Positive | Positive | 157.4 | yes |
| HER2-low | 14 | TCGA-A2-A04T | IHC score 2+ and ISH negative | 2+ | Negative | Negative | Negative | 74.48 | yes |
| HER2-low | 15 | TCGA-5L-AAT0 | IHC score 1+ with no positive ISH | 1+ | [Not Evaluated] | Positive | Positive | 156.8 | yes |
| HER2-low | 16 | TCGA-A2-A0ES | IHC score 1+ with no positive ISH | 1+ | Negative | Positive | Positive | 151.7 | yes |
| HER2-low | 17 | TCGA-A2-A04Q | IHC score 2+ and ISH negative | 2+ | Negative | Negative | Negative | 35.86 | yes |
| HER2-low | 18 | TCGA-5T-A9QA | IHC score 2+ and ISH negative | 2+ | Negative | Positive | Negative | 216.2 | yes |
| HER2-low | 19 | TCGA-A2-A0EN | IHC score 2+ and ISH negative | 2+ | Negative | Positive | Positive | 92.41 | yes |
| HER2-low | 20 | TCGA-A2-A0T6 | IHC score 1+ with no positive ISH | 1+ | [Not Evaluated] | Positive | Positive | 252.8 | yes |
...
| HER2-positive | 12 | TCGA-A2-A0EY | IHC score 3+ | 3+ | Positive | Positive | Negative | 1681 | yes |
| HER2-positive | 13 | TCGA-A2-A0T1 | IHC score 3+ | 3+ | [Not Evaluated] | Negative | Negative | 1699 | yes |
| HER2-positive | 14 | TCGA-A1-A0SM | IHC score 3+ | 3+ | Positive | Positive | Negative | 3101 | yes |
| HER2-positive | 15 | TCGA-A2-A04U | ISH positive | 1+ | Positive | Negative | Negative | 28.21 | yes |
| HER2-positive | 16 | TCGA-A2-A0D1 | IHC score 3+ | 3+ | Positive | Negative | Negative | 1123 | yes |
| HER2-positive | 17 | TCGA-A2-A04W | ISH positive | [Not Available] | Positive | Negative | Negative | 1133 | yes |
| HER2-positive | 18 | TCGA-A2-A0SY | ISH positive | [Not Available] | Positive | Positive | Positive | 420 | yes |
| HER2-positive | 19 | TCGA-A2-A0EQ | IHC score 3+ | 3+ | Negative | Negative | Negative | 78.19 | yes |
| HER2-positive | 20 | TCGA-A2-A0CX | IHC score 3+ | 3+ | [Not Evaluated] | Positive | Negative | 1466 | yes |
...
| HER2-zero | 13 | TCGA-A2-A0T2 | IHC score 0 with no positive ISH | 0 | [Not Evaluated] | Negative | Negative | 40.53 | yes |
| HER2-zero | 14 | TCGA-A2-A0CM | IHC score 0 with no positive ISH | 0 | [Not Evaluated] | Negative | Negative | 42.18 | yes |
| HER2-zero | 15 | TCGA-A2-A0EV | IHC score 0 with no positive ISH | 0 | Negative | Positive | Positive | 226.6 | yes |
| HER2-zero | 16 | TCGA-A2-A0D2 | IHC score 0 with no positive ISH | 0 | Negative | Negative | Negative | 61.59 | yes |
| HER2-zero | 17 | TCGA-A2-A0EW | IHC score 0 with no positive ISH | 0 | Negative | Positive | Positive | 141.1 | yes |
| HER2-zero | 18 | TCGA-A2-A0D0 | IHC score 0 with no positive ISH | 0 | Negative | Negative | Negative | 38.39 | yes |
| HER2-zero | 19 | TCGA-A1-A0SK | IHC score 0 with no positive ISH | 0 | [Not Evaluated] | Negative | Negative | 6.718 | yes |
| HER2-zero | 20 | TCGA-A2-A0T0 | IHC score 0 with no positive ISH | 0 | [Not Evaluated] | Negative | Negative | 54.48 | yes |

## Local Outputs

- Cases CSV: `data/tcga_brca/clinical_her2_cohort_expanded20_cases.csv`
- Slide table: `data/tcga_brca/clinical_her2_cohort_expanded20_slides_files.csv`
- Slide manifest: `data/tcga_brca/clinical_her2_cohort_expanded20_slide_manifest.tsv`
